...
var _BaseComponent2 = __webpack_require__(22);
...
var Splitter = function (_BaseComponent) {
  ...
  _createClass(Splitter, [{
    ...
    value: function render() {
      ...
      // prepare masking
      var masking = lockContent ? isSideOpen ? 'masking' : '' : '';
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { className: 'splitter' },
          this.props.children,
          _react2.default.createElement('div', { className: masking })
        )
      );
    }
  }]);
 ...
 * @extends BaseComponent 
 * */
var SplitterContent = function (_BaseComponent) {
  _inherits(SplitterContent, _BaseComponent);
...
var _animation = __webpack_require__(97);
 ...
 * @extends BaseComponent 
 * */
var SplitterSide = function (_BaseComponent) {
  _inherits(SplitterSide, _BaseComponent);
   ...
   *  
   */
  function SplitterSide(props) {
    _classCallCheck(this, SplitterSide);

    var _this = _possibleConstructorReturn(this, (SplitterSide.__proto__ || Object.getPrototypeOf(SplitterSide)).call(this, props));
    ...
    _this.bind('_getInstance', '_getAndFormatWidth');
  ...
  _createClass(SplitterSide, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.isOpen !== this.state.isOpen) {
        var animation = null;
        var to = 0;
        var anim = nextProps.animation || 'none';
        var animOptions = nextProps.animationOptions || null;
        if (anim && anim !== 'none') {
          ...
          this.setState({ animation: animation, isOpen: nextProps.isOpen });
        }
        setTimeout(function () {
          _this2.setState({ animation: null });
        }, to);
      }
    }
  }, {
    key: 'render',
    value: function render() {
      var width = this._getAndFormatWidth();
      var isOpen = this.props.isOpen || false;
      var side = this.props.side || 'left';
      var position = side === 'right' ? isOpen || this.state.animation ? { right: 0 } : { right: '-' + this.state.width + 'px' } : isOpen || this.state.animation ? { left: 0 } : { left: '-' + this.state.width + 'px' };
      var style = _extends({}, this.state.animation, position, width);
      return _react2.default.createElement(
        'sg-splitter-side',
        null,
        _react2.default.createElement(
          'div',
          { ref: this._getInstance, style: style },
          this.props.children
        )
      );
    }
    ...
    key: '_getInstance',
    value: function _getInstance(el) {
      this.instance = el;
    }
  }, {
    key: '_getAndFormatWidth',
    value: function _getAndFormatWidth() {
      if (!this.props.width) {
        return null;
      }

      if (_util2.default.isNumber(this.props.width)) {
        return { width: this.props.width + 'px' };
      }

      var width = this.props.width.trim();
...
exports.SplitterContent = exports.SplitterSide = exports.Splitter = exports.Navigator = exports.Page = exports.BaseComponent = undefined;

var _BaseComponent = __webpack_require__(22);
...
var _Navigator = __webpack_require__(95);
...
var _Splitter = __webpack_require__(183);
...
var _SplitterSide = __webpack_require__(185);

Object.defineProperty(exports, 'SplitterSide', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_SplitterSide).default;
  }
});

var _SplitterContent = __webpack_require__(184);

Object.defineProperty(exports, 'SplitterContent', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_SplitterContent).default;
  }
});
 ...
 * @extends BaseComponent 
 * */
var Page = function (_BaseComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      */
      var shallowCloneElement = function shallowCloneElement(element) {
        var children = [];
        if (_util2.default.isString(element)) {
          return element;
        }

        if (element.props.children) {
          children = _react2.default.Children.map(element.props.children, function (child) {
            return shallowCloneElement(child);
          });
        }

        if (element.type && element.type.sgPageChild) {
          return _react2.default.cloneElement(element, { page: _this3.page }, children);
        } else {
          return _react2.default.cloneElement(element, {}, children);;
        }
      };
